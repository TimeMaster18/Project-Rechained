namespace SingleplayerLauncher.Model
{
    public class Trait : LoadoutItem
    {
        ...
        // Bonus Traits
        public static Trait BONUS_TRAIT_ARMOR = new()
        {
            CodeName = "SpitfireGame.RWeaverBonusTraitArmor",
            Description = "+8 armor.",
            SiegeDescription = "+8 armor."
        };
        public static Trait BONUS_TRAIT_CC_RESIST = new()
        {
        ...
        public static Trait BONUS_TRAIT_PRIMARY_DAMAGE = new()
        {
        ...
        public static Trait BONUS_TRAIT_SPEED = new()
        {
